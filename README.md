...
**Some font files for Persian, Arabic and Hebrew are still loaded from Google in [assets/scss/rtl/_main.scss](assets/scss/rtl/_main.scss). PRs welcome to replace them.**
